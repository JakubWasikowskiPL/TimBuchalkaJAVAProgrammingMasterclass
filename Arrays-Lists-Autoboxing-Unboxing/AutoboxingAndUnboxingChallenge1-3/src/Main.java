...
//    NOTE:  If you get an error from the Evaluate class, it's most likely the constructor. Check if you've added a constructor or if the constructor has the right arguments.
    public static void main(String[] args) {
        ...
        bank.addBranch("Melbourn");

        if (!bank.addCustomer("Melbourn","Brian",5.53)){
            System.out.println("Error Melbourn branch does not exist");
        }
        ...
        if (!bank.addCustomer("Sydney","Tim",12.21)){
            System.out.println("Customer Tim already already exist");
        }
